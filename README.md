...
with the unoptimized v1 checker. TLC handles the exhaustive instances in
tens of seconds with 10 workers (and cross-validates quintck's state
counts exactly); quintck checks them a further ~4x faster at ~10-15x
less memory.
